...
const STORAGE_KEY = "locka.patient.wallet";

/** A testnet account used to populate the sample ledger. */
export const DEMO_PATIENT_ADDRESS = "GDPATIENTAMARAOKAFORNIOJPKQLRMSNTOUPVQWRXSYTZU2V3W4X5Y6Z";
...
const demoAdapter: WalletAdapter = {
  ...
  async connect() {
    ...
    window.localStorage.setItem(STORAGE_KEY, DEMO_PATIENT_ADDRESS);
    return DEMO_PATIENT_ADDRESS;
  },
