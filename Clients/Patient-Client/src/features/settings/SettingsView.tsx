...
const CONTRACTS = [
  {
    ...
    role: "Holds your passport id, identity commitment, and recovery account.",
  },
  {
    key: "providerRegistry" as const,
    name: "ProviderRegistry",
    role: "Records which providers are verified and may ask for access.",
  },
  {
    key: "medicalRecordRegistry" as const,
    name: "MedicalRecordRegistry",
    role: "Anchors a hash per record so documents can be checked.",
  },
  {
    key: "consentAccessManager" as const,
    name: "ConsentAccessManager",
    role: "Stores each grant, its scope, its window, and its revocation.",
  },
];
